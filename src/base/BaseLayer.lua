...
function BaseLayer:ctor()
	self.eventListener = function(eventName,data)
		self:onListenMyEvent(eventName,data)
	end
	--层生命周期事件处理
...
function BaseLayer:onExit()
	...
	EventDispatcher:getInstance():removeEventListener(self.eventListener)
end
...
--事件监听
--
function BaseLayer:dispatchMyEvent(eventName,data)
    EventDispatcher:getInstance():dispatcherEvent(eventName,data)
end

function BaseLayer:becomeMyEventListener(eventName)
    EventDispatcher:getInstance():addEventListener(eventName,self.eventListener)
end

function BaseLayer:onListenMyEvent(eventName,data)
    print(self.__cname.. " onListenMyEvent:"..eventName)
end
